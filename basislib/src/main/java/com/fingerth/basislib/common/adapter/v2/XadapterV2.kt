...
class XadapterV2<T>(private val con: Context) {
    ...
    class WithLayout<T>(private val con: Context, private val mData: List<T>, private val type: (T) -> Any = {}, private val list: ArrayList<Pair<Any, Int>>, private val defaultLayout: Int) {
        ...
        fun itemAnimation(mAnimation: ImAnimation? = null): WithLayout<T> {
    ...
    abstract class XRecyclerAdapter<T>(private val context: Context, var mList: List<T>, private val type: (T) -> Any = {}, private val list: ArrayList<Pair<Any, Int>>, private val defaultLayout: Int, private val mAnimation: ImAnimation? = null) : RecyclerView.Adapter<XRecyclerAdapter.XViewHolder>() {
        ...
        class XViewHolder(private val view: View) : RecyclerView.ViewHolder(view), BaseHolder {
